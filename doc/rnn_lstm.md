<!--------------------------------------------------------------------------------- LSTM -->
# LSTM
[AI] > [Resolve] > [Learning] > [Algorithm] > [Neural network] > [Network] > [RNN] > [Architecture]
...
Article
```
1997 : LSTM             : Sepp hochreiter | Jurgen schmidhuber
2007 : Learnin to Foget : Felix A. | Jurgen schmidhuber | Fred Cummins
```
...
[RNN]: https://github.com/kashanimorteza/ai_document/blob/main/doc/rnn.md
[Network]: https://github.com/kashanimorteza/ai_document/blob/main/doc/neural_network.md#network
[Architecture]: https://github.com/kashanimorteza/ai_document/blob/main/doc/rnn.md#architecture